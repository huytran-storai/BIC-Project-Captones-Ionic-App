...
@NgModule({
  ...
  declarations: [TabmenuComponent,ProductListComponent,ProductDetailsComponent, BlogsComponent],
  imports: [CommonModule, IonicModule,RouterModule],
  exports:[TabmenuComponent, ProductListComponent,ProductDetailsComponent, BlogsComponent],
})
